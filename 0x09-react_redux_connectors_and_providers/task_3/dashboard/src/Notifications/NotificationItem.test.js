...
describe("Notification item rendering tests", () => {
  ...
  it("renders correct output for type and value props", () => {
    ...
    expect(wrapper.html()).toEqual(
      '<li data-notification-type="default" class="defaultNotification_cvq36q">test</li>'
    );
  });
  ...
  it("renders correct output for html props", () => {
    ...
    expect(wrapper.html()).toEqual(
      '<li data-notification-type="urgent" class="urgentNotification_iuuqm8"><u>test</u></li>'
    );
  });
