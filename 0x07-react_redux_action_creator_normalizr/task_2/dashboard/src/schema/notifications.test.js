...
describe("getAllNotificationsByUser tests", () => {
  ...
  it("verifies that normalized data has a correct users entity", () => {
    const expectedUser = {
      age: 25,
  ...
  it("verifies that normalized data has a correct messages entity", () => {
  ...
  it("verifies that normalized data has a correct notifications entity", () => {
